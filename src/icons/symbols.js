...
export const ICONS = {
    ...
    // ---- Premium chat icons (Phase 3.2) ----------------------------------
    search: { viewBox: NS_VIEWBOX, filled: false, body: '<circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line>' },
    pin: { viewBox: NS_VIEWBOX, filled: false, body: '<path d="M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7z"></path><circle cx="12" cy="9" r="2.5"></circle>' },
    bookmark: { viewBox: NS_VIEWBOX, filled: false, body: '<path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>' },
